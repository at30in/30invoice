...
class Invoice extends BaseInvoice
{
  ...
  {
    //$next = $this->_table->getNextNumber($this->getSeriesId());
    $default_serie = sfContext::getInstance()->getUser()->getProfile()->getSeries();
    $next = $this->_table->getNextNumber($default_serie);
    $this->setNumber($next);
    return $next;
  }
  ...
  {
    $payment = Doctrine::getTable('PaymentMethods')->find($this->__get('payment_method_id'));
    if($payment)
    {
