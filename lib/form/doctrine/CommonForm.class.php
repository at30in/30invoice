...
class CommonForm extends BaseCommonForm
{
  ...
  public function configure()
  {
    ...
    $this->widgetSchema['payment_method_id'] = new sfWidgetFormSelect(array(
      'choices' => PaymentMethodsTable::getChoicesForSelect()));
    $this->widgetSchema['payment_method_id']->setDefault(
      PaymentMethodsTable::getDefault());
    $this->widgetSchema['payment_method'] = new sfWidgetFormInputText(array('default' => PaymentMethodsTable::getDefault(true)),
      array('size' => 80));
