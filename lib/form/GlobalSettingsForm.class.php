...
class GlobalSettingsForm extends FormsContainer
{
  ...
  public function configure()
  {
    ...
    $this->setWidgets(array(
      ...
      'company_vat'      => new sfWidgetFormInputText(),
    ...
    $this->setDefaults(array(
      ...
      'company_vat'      => PropertyTable::get('company_vat'),
    ...
    $this->setValidators(array(
      ...
      'company_vat'         => new sfValidatorString(array('max_length' => 30, 'required' => false)),
    ...
    $this->embedForm('payments',new PaymentsMethodsForm());
