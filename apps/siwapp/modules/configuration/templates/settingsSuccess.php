  ...
  <form action="<?php echo url_for('@settings') ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
    ...
    <fieldset class="left">
      ...
      <ul>
        ...
        <?php echo $form['company_vat']->renderRow(array('class' => error_class($form['company_vat']))) ?>
    ...
    <fieldset class="payments taxseries">
      ...
      <div class="clear"></div>
      <small>
        <a id="addNewPayment" href="#" class="to:payments"><?php echo __('Add a new payment method value') ?></a>
      </small>
    </fieldset>
