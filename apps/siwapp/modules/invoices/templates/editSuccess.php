...
<div id="invoice-container" class="content">
  ...
  <?php 
    ...
    include_partial('common/invoiceInfo', array('invoiceForm' => $invoiceForm)); 
    include_partial('common/clientInfo', array('invoiceForm' => $invoiceForm)); ?>

  <!-- Description block -->
  <?php include_partial('common/description', array('invoiceForm' => $invoiceForm)); ?>
  ...
  <?php include_partial('common/paymentMethods', array('invoiceForm' => $invoiceForm)); ?>
